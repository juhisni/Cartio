...
object DatabaseModule {
    @Provides @Singleton fun database(@ApplicationContext context: Context): CartioDatabase = Room.databaseBuilder(context, CartioDatabase::class.java, "cartio.db").addMigrations(CartioDatabase.MIGRATION_1_2).build()
